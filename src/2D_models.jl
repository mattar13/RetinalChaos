...
#Version test1: Testing Unwinding and Inbounds
function (PDE::Network{T, :test1})(dU::Array{T,3}, U::Array{T,3}, p::Array{T,1}, t::T, DA::Array{T,2}) where T <: Real
    ...
    I_calc!(dv, v, n, b, e, W, I_app, g_leak, E_leak, g_Ca, E_Ca, g_K, E_K, g_TREK, g_ACh, E_ACh, V1, V2, k_d)
...
function (PDE::Network{T, :test3})(dU::Array{T,3}, U::Array{T,3}, p::Array{T,1}, t::T, DA::Array{T,2}) where T <: Real
    v = view(U, :, :, 1)
    n = view(U, :, :, 2)
    c = view(U, :, :, 3)
    a = view(U, :, :, 4)
