...
function calculate_STTC(signal1::BitArray{1}, signal2::BitArray{1}; Δt::Float64 = 50.0, dt = 1.0)
    ...
    burst_conv1, burst_idxs1 = convolve_bursts(signal1, Δt; dt = dt, include_theta = true);
    burst_conv2, burst_idxs2 = convolve_bursts(signal2, Δt; dt = dt, include_theta = true);
