...
const GABA_pars = [:g_leak, :E_leak, :g_Ca, :V1, :V2, :E_Ca, :g_K, :E_K, :g_TREK, :g_ACh, :k_ACh, :E_ACh, :g_GABA, :k_GABA, :E_GABA, :I_app, :C_m, :V3, :V4, :τn, :C_0, :λ, :δ, :τc, :α, :τa, :β, :τb, :ρe, :ρi, :τACh, :τGABA, :ke, :ki, :V0e, :V0i, :D, :τw, :σ]
