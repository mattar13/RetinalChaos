...
# ╔═╡ 413b97c7-0543-4e6b-951a-6acad87117f7
begin
...
# ╔═╡ 4fdb919f-ce59-4dc5-a010-bd0c133abda2
begin
...
md"
#### Load Data for 
- An grid simulation with no synchronized activity
- A grid simulation with 

"

# ╔═╡ 9e702cf9-81f7-4f72-9082-0e9eee9a1ec2
data_loc = "E:\\Data\\Modelling"

# ╔═╡ 6c578a10-adee-45b5-a983-b31da5b6dd5a
begin
...
# ╔═╡ a9ec5ad1-dc11-4d37-9108-118c98f681b4
begin
...
# ╔═╡ a26ab9d8-05fc-4185-9ae4-9508f6a4991c
begin
...
# ╔═╡ 82b8f4c2-a441-4fd0-bc7f-2bcbb71db705
begin
...
# ╔═╡ cce21f5e-447d-4e91-a59c-8413d3a0133a
md"
# Making the figure
...
# ╔═╡ 852ad9ad-6905-433f-8175-75bb238e39da
phys_color = :green

# ╔═╡ 9eee4935-fe88-4392-bedf-dce592c14b4e
iso_color = :blue

# ╔═╡ 365c4f35-43ea-4514-bd11-8f99f3c91c0f
net_color = :orange

# ╔═╡ 4e6c5aee-c93d-4752-ba70-c97d828381d0
begin
	thresh = NeuroPhys.calculate_threshold(data)
...
# ╔═╡ 93e7e366-5310-48e0-be52-8e0429ea1ad0
n_hist_bins = 10
...
NeuroPhys = "0612f44b-defb-466c-a561-fff8bd3ecefc"
...
[[NeuroPhys]]
deps = ["Colors", "ConfigEnv", "DSP", "DataFrames", "Dates", "Distributions", "FFTW", "HypothesisTests", "JSON", "JSON2", "LsqFit", "Plots", "Polynomials", "PrettyTables", "PyCall", "Query", "Revise", "Statistics", "StatsBase", "StatsPlots", "Telegram", "Wavelets", "XLSX"]
git-tree-sha1 = "7fe85738e6764d78747993fbdd40a2433b3534ff"
repo-rev = "master"
repo-url = "https://github.com/mattar13/NeuroPhys.git"
uuid = "0612f44b-defb-466c-a561-fff8bd3ecefc"
version = "0.2.0"
