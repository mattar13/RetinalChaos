...
gif(anim, "$(loc)/S2 Neurotransmission Blocked Simulation.gif", fps=1000.0 / animate_dt)
...
gif(anim, "$(loc)/S3 NoGABA Simulation.gif", fps=1000.0 / animate_dt)
...
gif(anim, "$(loc)/S4 Wave Simulation.gif", fps=1000.0 / animate_dt)