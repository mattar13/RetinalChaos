...
# ╔═╡ 5e71f17d-0b75-43ba-b622-46817b319bd3
timestamps["Bursts"]
...
begin 	
	...
	C_trng = C_xlims[1]:1.0:C_xlims[2]+5000
end
...
[[RetinalChaos]]
deps = ["BSON", "CUDA", "ColorSchemes", "Colors", "ConfigEnv", "DataDeps", "Dates", "DiffEqBase", "DifferentialEquations", "Distributions", "ForwardDiff", "ImageSegmentation", "Images", "JLD2", "JSON2", "LaTeXStrings", "LinearAlgebra", "LsqFit", "Measures", "ModelingToolkit", "NLsolve", "NeuroPhys", "OrdinaryDiffEq", "Plots", "Pluto", "ProgressMeter", "PyCall", "RandomNumbers", "ResettableStacks", "Revise", "Statistics", "StatsBase", "StatsPlots", "StochasticDiffEq", "Telegram", "TerminalLoggers"]
git-tree-sha1 = "4475530e0dcfb0963b1cf9fd70370b427f2ad515"
repo-rev = "master"
